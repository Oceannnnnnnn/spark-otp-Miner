...
if __name__ == '__main__':
    ...
    # print("请输入min_sup：")
    # min_sup = int(input())
    file = "E:\\code_postgraduation\\OTP-Miner\\datasets\\SDB3.txt"
    s = "hilkmftwv"
    m = "rcqgpsyn"
    w = "adeuox"
    min_gap = 0
    ...
    # NTP_Miner("E:\\code_postgraduation\\OTP-Miner\\datasets\\SDB3.txt", "hilkmftwv", "rcqgpsyn", "adeuox", 0, 3, 400).solve_test()
